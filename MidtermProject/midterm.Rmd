...
df <- read.csv(file = "~/Documents/HW/MA615/Assignments/MidtermProject/oilgascounty.csv")
set.seed(100)
...
# change column names for plotting later
oilsum <- setNames(oilsum, c("State", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011"))
gassum <- setNames(gassum, c("State", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009","2010", "2011"))
...
# convert year into vector
ggplot(gassum2, aes(x = variable, y = value)) + geom_boxplot(aes(fill = variable)) + xlab("Year") + ylab("log10(thousand cubic feet)") + ggtitle("Gas Production in US (48 states)")
